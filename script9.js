function clr(a)
      {
        ...
        {
          case 1:
          document.getElementById('iph').src = "img14.png";
            break;
          case  2:
            document.getElementById('iph').src = "img10r.png";
...
function namech()
{
  document.getElementById('card1').value = document.getElementById('nameinp').value;
}